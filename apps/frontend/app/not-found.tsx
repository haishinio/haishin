  ...
  return (
    <div className="min-h-screen w-full max-w-screen-md mx-auto text-center flex items-center">
      <div className="w-full">
        ...
        <p>If you are repeatedly reaching here maybe give <a href="https://twitter.com/tomouchuu" target="_blank" className="underline">Thomas</a> a buzz to see if there is an issue!</p>
        <p className="mt-4">While you are here, how about some <a href={randomArtistSong.url} target="_blank" className="underline">{randomArtistSong.group}</a>?</p>
      </div>
    </div>
  )
}